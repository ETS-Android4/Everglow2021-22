...
public class OldCameraSystem {
    ...
    public OldCameraSystem(LinearOpMode opMode, Side side) {
        this.side = side;
        this.opMode = opMode;
    ...
    public boolean testFrame(){
        ...
        if (imageProcessor == null){
            imageProcessor = new ImageProcessor(bmp, side);
        }
        return imageProcessor.isFrameValid(bmp);
    ...
    public ArmSystem.Floors detectTotem(){
        ...
        return imageProcessor.findFloor(bmp);
    }
    ...
    private void openCamera() {
        ...
        opMode.telemetry.addLine("Location 1");
    ...
    private void startCamera() {
        ...
        opMode.telemetry.addLine("Location 2");
        opMode.telemetry.update();
...
//        final Size size = cameraCharacteristics.getDefaultSize(imageFormat);
        ...
        opMode.telemetry.addLine("Location 3");
        opMode.telemetry.update();
        ...
        try {
            synchronizer.await();
            opMode.telemetry.addLine("Location 10");
            opMode.telemetry.update();
